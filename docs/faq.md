...
- A **CSV** for use in Excel, Stata, SPSS, and similar tools
- A **shapefile** for use in GIS software
- A **PDF / HTML metadata file** with dataset descriptions, citation information, and sources

### How long will it take to receive my data?
Many requests complete almost instantly due to preprocessing and caching. Requests requiring new processing may take up to several hours, particularly for selections with a large number of project locations.

### Why are some years missing from the filter for a dataset?
...
You can read the GeoQuery paper or visit [aiddata.org/geoquery](https://aiddata.org/geoquery) for links to the codebase, additional resources, and documentation. See also [Citing GeoQuery](citing.md).
