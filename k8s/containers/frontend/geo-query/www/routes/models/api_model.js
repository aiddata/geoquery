    ...
    .then(function (response) {
      ...
      var boundaries = _.map(response.data, function (value, key) {
        var groupTitle = _.chain(value)
          .find(function (d) {
            return _.has(d, "options.group_title");
          })
...
module.exports.geometry = function (req, res) {
  ...
  return sendRequest("get_boundary_geojson", {
    name: geomId,
...
module.exports.datasets = function (req, res) {
  ...
  return sendRequest("get_relevant_datasets", {
    group: boundaryId,
    domain: req.body.domain,
  })
    .then(function (response) {
...
module.exports.filters = function (req, res) {
  ...
  return sendRequest("get_filter_count", {
    filter: filterData,
    domain: req.body.domain,
  })
    .then(function (response) {
...
module.exports.requestLookup = function (req, res) {
  ...
  if (!searchType || !searchVal) {
    return res
      .status(400)
      .send({ message: "Must provide a search value and search type" });
  }
