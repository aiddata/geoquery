...
- Put a dataset JSON into `/backend/dev_data/`, e.g. [`esa_landcover.json`](https://raw.githubusercontent.com/cmhwang/geo-datasets/7d5148dafe47a3c9532aa718313ae7c7e3fd5d6d/datasets/esa_landcover/raster_ingest.json)
- Edit the path at the top of the JSON file to e.g. `"dev_data/rasters/esa_landcover"`
- `cd` to `/backend`
- `uv run manage.py ingest_dataset dev_data/esa_landcover.json`
