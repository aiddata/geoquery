...
{:else}
  ...
  >
    ...
    <text x="200" y="13" text-anchor="middle" font-size="10" font-weight="600" fill="#1e293b">{ds || niceName(card.column)}</text>
    <text x="200" y="25" text-anchor="middle" font-size="9" fill="#64748b">{colPart} — {typeLabel}</text>
    {#each rows as row, i}
